...
//                        and().ignoring().antMatchers("/shopfuniture/category").
//                        and().ignoring().antMatchers("/shopfuniture/category/*").
//                        and().ignoring().antMatchers("/shopfuniture/{id}").
//                        and().ignoring().antMatchers("/shopfuniture/categoryPaging/{index}").
//                        and().ignoring().antMatchers("/shopfuniture/home-page/{index}").
