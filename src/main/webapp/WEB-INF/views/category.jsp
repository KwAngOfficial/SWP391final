                        ...
                        <div class="widgets_inner">
                            <ul class="list">
                                <c:forEach items="${category}" var="c">
                                    <li>
                                        <a href="/shopfuniture/category/${c.cid}">${c.c_name}</a>
                                    </li>
                                </c:forEach>
                            </ul>
                        </div>
                    ...
                    <div class="col-lg-12">
                        <div class="product_top_bar d-flex justify-content-between align-items-center">
                            <div class="single_product_menu">
                                <p><span>${product.size()} </span> Product Found</p>
                            </div>
                        ...
                        <div class="col-lg-4 col-sm-4">
                            ...
                            <div class="single_product_item">
                                <a href="/shopfuniture/single_product_item/${p.pid}">
                                    <img src="<c:url value="/assets/img/product/${p.p_image}"/>" alt="">
                            ...
                            <nav aria-label="Page navigation example">
                                <ul class="pagination justify-content-center">
                                    ...
                                    <c:forEach begin="1" end="${endP}" var="i">
                                        <li class="page-item">
                                            <a class="page-link" href="/shopfuniture/categoryPaging/${i}">
